...
import io.github.prolobjectlink.prolog.jiprolog.JiPrologOperatorSet;

public class PrologOperatorSetTest {

	private PrologOperatorSet s = new JiPrologOperatorSet();
...
//		assertTrue(s.currentOp("atan"));
	...
	public void testEquals() {
		assertTrue(s.equals(new JiPrologOperatorSet()));
	...
	public void testHashCode() {
		assertTrue(s.hashCode() == new JiPrologOperatorSet().hashCode());
