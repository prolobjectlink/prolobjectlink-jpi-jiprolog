...
import io.github.prolobjectlink.prolog.jiprolog.JiPrologIndicator;
import io.github.prolobjectlink.prolog.jiprolog.JiPrologOperator;
...
public class PrologEngineTest extends PrologBaseTest {
	...
	public final void testCurrentPredicates() {
		JIPEngine prolog = new JIPEngine();
		Set<PrologIndicator> builtins = new HashSet<PrologIndicator>();
		Collection<JIPClausesDatabase> collection = prolog.getGlobalDataBase();
	...
	public final void testCurrentOperators() {
		...
		OperatorManager manager = prolog.getOperatorManager();
...
//		assertTrue(engine.currentOperator(1200, "xfx", ":-"));
	...
	public final void testGetLicense() {
		assertEquals(Licenses.AGPL_V3, engine.getLicense());
	}
	...
	public final void testGetName() {
		assertEquals("JIProlog", engine.getName());
	}
