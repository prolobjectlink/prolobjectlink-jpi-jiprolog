 ...
 * @since 1.1
 */
public final class JiPrologEntry extends AbstractCompounds implements PrologEntry {

	private final PrologTerm key;
	private PrologTerm value;

	JiPrologEntry(PrologProvider provider, PrologTerm key, PrologTerm value) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		JiPrologEntry other = (JiPrologEntry) obj;
		if (key == null) {
			if (other.key != null)
				return false;
