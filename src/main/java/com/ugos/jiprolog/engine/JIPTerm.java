...
// #ifndef _MIDP
		, Serializable, Cloneable, Comparable<JIPTerm>
// #endif

{
	...
	/**
	 * Checks if this JIPTerm object unifies with the specified term. Remarks:
	 * this method doesn't bind any variable. To actually unifies the terms use
	 * the other method unify.
	 * 
	 * @param term
	 *            term to unify
	...
	/**
	 * Unifies this JIPTerm object with the specified term. If this JIPTerm
	 * object unifies with the specified term this method unifies the terms and
	 * varTable will contains the variables that has been bound.
	 * 
	 * @param term
	 *            term to unify
	 * @param varTable
	 *            the hashtable containing the variable that has been bound.
	 * @return true if the this object unify with the specified term.
	 */
	...
	/**
	 * Returns a string representation of this JIPTerm object using the operator
	 * declarations contained in JIPEngine object. It has the same behaviour as
	 * write/1
	 * 
	 * @param engine
	 *            the JIPEngine object containing operator declarations
	...
	/**
	 * Returns a quoted string representation of this JIPTerm object using the
	 * operator declarations contained in JIPEngine object. It has the same
	 * behaviour as writeq/1
	 * 
	 * @param engine
	 *            the JIPEngine object containing operator declarations
	 * @return a string representation of this JIPTerm object
	...
	/**
	 * Gets an array of JIPVariable objects containing the variables in this
	 * JIPTerm object
	 * 
	 * @return an array of JIPVariable objects containing the variables in this
	 *         JIPTerm object
	...
	/**
	 * Gets an hashtable of JIPVariable objects containing the variables in this
	 * JIPTerm object.<br>
	 * Variable names are the keys to access to the hashtable.
	 * 
	 * @return an hashtable of JIPVariable objects containing the variables in
	 *         this JIPTerm object.<br>
	 * @see com.ugos.jiprolog.engine.JIPVariable
	 */
	...
	public int compareTo(JIPTerm o) {
		PrologObject thisObject = m_obj;
		PrologObject otherObject = o.m_obj;
		if (thisObject.equals(otherObject)) {
			return 0;
		} else if (thisObject.lessThen(otherObject)) {
			return -1;
		}
		return 1;
	}
