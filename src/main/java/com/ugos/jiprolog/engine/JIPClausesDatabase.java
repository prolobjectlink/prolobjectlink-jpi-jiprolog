 ...
 * To implement a custom database of clauses, developers should implement the
 ...
 * <i>"How to implement a custom detabase of clauses"</i> in the Reference
 * Manual.
 * 
 * @version 2.0
...
public abstract class JIPClausesDatabase extends Object {
	...
	/**
	 * Sets the attributes to pass to the database (i.e. login info, filename,
	 * etc.)
	 * 
	 * @param strAttribs
	 ...
	 * Note that some databases may not allow to add a clause at a given
	 * position.<br>
	 * 
	 * @param nPos
	 *            Position of the clause to add
	 * @param clause
	 *            Clause to add
	...
	/**
	 * Removes a clause from the database Note that some databases may not allow
	 * to remove a clause.<br>
	 * 
	 * @param clause
	 *            Clause to remove
