...
final class JiPrologDouble extends JiPrologTerm implements PrologDouble {

	JiPrologDouble(PrologProvider provider) {
		super(DOUBLE_TYPE, provider, JIPNumber.create(0));
	}

	JiPrologDouble(PrologProvider provider, Number value) {
