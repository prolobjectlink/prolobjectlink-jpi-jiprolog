...
final class JiPrologLong extends JiPrologTerm implements PrologLong {

	JiPrologLong(PrologProvider provider) {
		super(LONG_TYPE, provider, JIPNumber.create(0));
	}

	JiPrologLong(PrologProvider provider, Number value) {
